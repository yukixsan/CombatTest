...
namespace ASP
{
    ...
    /// </summary>
    [Serializable, VolumeComponentMenu("Post-processing/ASP Screen Space Lens Flare")]
    public class ASPScreenSpaceLensFlare : VolumeComponent, IPostProcessComponent
    {
        /// <summary>
        ...
        /// </summary>
        [AdditionalProperty] public ClampedIntParameter bloomMip = new ClampedIntParameter(1, 0, 5);

        /// <summary>
        /// Controls the intensity of the Regular Flare sample. Those flares are sampled using scaled screen coordinates.
        /// </summary>
        [Header("Flares")] public MinFloatParameter firstFlareIntensity = new MinFloatParameter(1f, 0f);
        ...
        /// </summary>
        [AdditionalProperty] public Vector2Parameter warpedFlareScale = new Vector2Parameter(new Vector2(1f, 1f));
        ...
        /// </summary>
        [AdditionalProperty] public ClampedFloatParameter sampleDimmer = new ClampedFloatParameter(0.5f, 0.1f, 1f);
        ...
        /// </summary>
        [Header("Streaks")] public MinFloatParameter streaksIntensity = new MinFloatParameter(0f, 0f);
        ...
        /// </summary>
        [SerializeField] [AdditionalProperty] public ScreenSpaceLensFlareResolutionParameter resolution =
            new ScreenSpaceLensFlareResolutionParameter(ScreenSpaceLensFlareResolution.Quarter);
        ...
        /// </summary>
        public ASPScreenSpaceLensFlare()
        {
            displayName = "Screen Space Lens Flare(ASP)";
        }
